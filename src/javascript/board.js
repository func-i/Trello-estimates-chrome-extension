...
(function() {
  var addCardStats, ajaxCalls, ajaxErrorAlert, app, boardCards, boardPattern, cardStatsHtml, compareCardStats, getCardsOnBoard, serverURL, setCardBackground, showUpdatedCards, updateCards;
